...
จากรูปที่ \ref{Fig:structure_app} สามารถอธิบายโครงสร้างและเทคโนโลยีของแอปพลิเคชันสูงวัยมายเฟรนด์ ได้ดังนี้
...
\begin{sidewaysfigure}
	\begin{figure}[H]
		\includegraphics[width=1.1\columnwidth]{Figures/3/Class/classdiagrams}

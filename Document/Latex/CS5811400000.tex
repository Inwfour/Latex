...
{ชื่อระบบภาษาไทย} % Thai Title
{English Project Title}      % English title (auto upper case)

\authortitle                            % set the title of the author, e.g., Mr., Miss, Dr. etc.
{นาย(นางสาว)}                                   % Thai Title of the author
{Mr.(Miss)}                                   % English Title of the author
\thesisauthor                           % set the author name (must not include title (Mr., Miss, Dr., etc.)
{ชื่อ สกุล}                          % Author name in Thai
{Firstname Lastname}                  % Author name in English

\advisor                                               % set the advisor
{อาจารย์ ดร.ชื่อ สกุล}               % Advisor name in Thai
{ดร. ชื่อ สกุล}                          % Advisor name in Thai with abbrev. title
{Firstname Lastname, Ph.D.}  % Advisor name in English
{FIRTNAME LASTNAME, Ph.D.}          % Advisor name in English with abbrev. title 
...
\CommitteeBlock{กรรมการ}{ผศ. ชื่อ สกุล} % examiner
\CommitteeBlock{กรรมการ}{อาจารย์ ชื่อ สกุล } % examiner
}
